  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-10 sm:px-6">
      <div className="mb-6">
        ...
        <h1 className="mt-2 font-display text-3xl font-semibold text-slate-900">Review your selected products</h1>
      </div>
      ...
      <div className="grid gap-6 lg:grid-cols-[1.1fr_0.9fr]">
        <div className="space-y-4">
          {cart.items.length === 0 ? (
            <div className="rounded-[32px] border border-dashed border-slate-300 bg-white p-10 text-center">
              ...
              <p className="mt-2 text-sm text-slate-500">Add a product from the storefront to begin checkout.</p>
              ...
              <div key={item.product_id} className="flex gap-4 rounded-[28px] border border-slate-200 bg-white p-4">
                ...
                <div className="flex flex-1 flex-col justify-between">
                  <div>
                    ...
                    {item.failure_mode ? (
                      <p className="mt-2 text-xs font-medium uppercase tracking-[0.14em] text-orange-600">Chaos demo item</p>
                    ) : null}
                  </div>
        ...
        <aside className="rounded-[32px] border border-slate-200 bg-white p-6 shadow-[0_10px_35px_rgba(15,23,42,0.08)]">
          <p className="text-lg font-semibold text-slate-900">Price Details</p>
